...
if (url)
		...
		if (text)
	  	output += ']' + text +'[/button]';
					...
					output += ']'+ColumnsDialog.local_ed.selection.getContent() + '[/button]';
		}
...
<body>
	<div id="button-dialog">
		<form action="<?php echo home_url('/'); ?>" method="get" accept-charset="utf-8" id="button-form">
			...
			<div>
			<label for="button-url">Add URL</label>
			<input id="button-url" name="button-url" type="text" value="" />
			</div>
				<div>
			<label for="button-text">Add Text</label>
			<input id="button-text" name="button-text" type="text" value="" />
			</div>

...
//wp_enqueue_script( 'test', get_template_directory_uri() . '/js/themeajax.js',array('jquery'),'1.4.8',true);
...
'portfolio_menu' => __('Portfolio','saxon')
...
'not_found_in_trash' => __( 'No CPortfolio Items found in trash' ),
